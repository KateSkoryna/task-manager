...
const ChatPanel: React.FC = () => {
  ...
  return (
    <div
      ...
      className="fixed bottom-6 right-6 z-50 flex h-[32rem] w-96 max-w-[calc(100vw-3rem)] flex-col overflow-hidden rounded-card border border-default bg-surface shadow-menu print:hidden"
    >
